    ...
    return(
        ...
        <div className="homepage">
          <div className="threecol">
            <img alt="researcher" src={process.env.PUBLIC_URL + '/images/researcher.jpg'}></img>
          ...
          <div className="threecol">
            <img alt="participant" src={ process.env.PUBLIC_URL + '/images/participant.jpg'}></img>
            <div className="threecol-description">
            ...
            <Link to="/login">
              <img alt="staff" src={process.env.PUBLIC_URL + '/images/counselling.jpg'}></img>
              <div className="threecol-description">
